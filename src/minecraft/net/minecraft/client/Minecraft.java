...
public abstract class Minecraft implements Runnable {
	...
	private void clickMouse(int var1) {
		if (var1 != 0 || this.leftClickCounter <= 0) {
			...
			if (var2 && var1 == 1) {
				...
				if (this.playerController.sendUseItem(this.thePlayer, this.theWorld, var9) && var9 != null) { // Spout
																												// reordered
	...
	public void changeWorld(World var1, String var2, EntityPlayer var3) {
		...
		if (var1 != null) {
			...
			// Spout start
			/*
			 * Code Moved if(this.renderGlobal != null) {
			 * this.renderGlobal.changeWorld(var1); }
			 */
			// Spout end
			...
			// this.playerController.func_6473_b(this.thePlayer); //Spout
			// Garbage
			if (var3 != null) {
				var1.emptyMethod1();
			}
