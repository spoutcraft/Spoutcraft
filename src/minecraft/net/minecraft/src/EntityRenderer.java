...
public class EntityRenderer {
	...
	public void updateCameraAndRender(float var1) {
		...
		if(this.mc.inGameHasFocus || this.mc.currentScreen instanceof org.getspout.spout.gui.predownload.GuiPredownload) { //Spout
	...
	public void renderWorld(float var1, long var2) {
		...
		for(int var19 = 0; var19 < 2; ++var19) {
			...
			if(Config.isWaterFancy()) { //Spout Start
				...
				int var22 = var5.renderAllSortedRenderers(2, (double)var1); //Spout
				if(this.mc.gameSettings.anaglyph) {
					if(anaglyphField == 0) {
				...
				//Spout Start
				if(var22 > 0) {
					var5.renderAllSortedRenderers(2, (double)var1);
				}
				//Spout End

				GL11.glShadeModel(7424 /*GL_FLAT*/);
			} else {
				var5.sortAndRender(var4, 2, (double)var1);
			}
