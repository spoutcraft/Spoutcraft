...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addShapelessRecipe(new ItemStack(Item.field_77821_bF, 1), new Object[] {Item.book, new ItemStack(Item.dyePowder, 1, 0), Item.feather});
		...
		this.addRecipe(new ItemStack(Block.jukebox, 1), new Object[] {"###", "#X#", "###", '#', Block.planks, 'X', Item.field_77702_n});
		...
		this.addRecipe(new ItemStack(Block.field_72079_ak, 6, 3), new Object[] {"###", '#', Block.cobblestone});
		this.addRecipe(new ItemStack(Block.field_72079_ak, 6, 0), new Object[] {"###", '#', Block.stone});
		this.addRecipe(new ItemStack(Block.field_72079_ak, 6, 1), new Object[] {"###", '#', Block.sandStone});
		this.addRecipe(new ItemStack(Block.field_72079_ak, 6, 4), new Object[] {"###", '#', Block.brick});
		this.addRecipe(new ItemStack(Block.field_72079_ak, 6, 5), new Object[] {"###", '#', Block.stoneBrick});
		this.addRecipe(new ItemStack(Block.field_72092_bO, 6, 0), new Object[] {"###", '#', new ItemStack(Block.planks, 1, 0)});
		this.addRecipe(new ItemStack(Block.field_72092_bO, 6, 2), new Object[] {"###", '#', new ItemStack(Block.planks, 1, 2)});
		this.addRecipe(new ItemStack(Block.field_72092_bO, 6, 1), new Object[] {"###", '#', new ItemStack(Block.planks, 1, 1)});
		this.addRecipe(new ItemStack(Block.field_72092_bO, 6, 3), new Object[] {"###", '#', new ItemStack(Block.planks, 1, 3)});
		...
		this.addRecipe(new ItemStack(Block.enchantmentTable, 1), new Object[] {" B ", "D#D", "###", '#', Block.obsidian, 'B', Item.book, 'D', Item.field_77702_n});
	...
	public void addShapelessRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj) { // Spout private - public
