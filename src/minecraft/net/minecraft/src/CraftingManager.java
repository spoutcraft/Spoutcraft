...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.stairSingle, 3, 5), new Object[] { "###", Character.valueOf('#'), Block.stoneBrick });
	...
	public void addShapelessRecipe(ItemStack var1, Object... var2) { //Spout default -> public
