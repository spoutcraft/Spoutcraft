...
public class Chunk {
	...
	public Chunk(World var1, int var2, int var3) {
		...
		this.entities = new List[var1.field_35472_c / 16];
		this.worldObj = var1;
		this.xPosition = var2;
		this.zPosition = var3;
	...
	public Chunk(World var1, byte[] var2, int var3, int var4) {
		this(var1, var3, var4);
		this.blocks = var2;
		this.data = new NibbleArray(var2.length, var1.field_35473_a);
		this.skylightMap = new NibbleArray(var2.length, var1.field_35473_a);
		this.blocklightMap = new NibbleArray(var2.length, var1.field_35473_a);
	}
	...
	public void generateHeightMap() {
		int var1 = this.worldObj.field_35472_c - 1;

		for(int var2 = 0; var2 < 16; ++var2) {
			for(int var3 = 0; var3 < 16; ++var3) {
				this.precipitationHeightMap[var2 + (var3 << 4)] = -999;
				int var4 = this.worldObj.field_35472_c - 1;

				for(int var5 = var2 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a; var4 > 0 && Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
					;
				}
	...
	public void generateSkylightMap() {
		...
		for(var2 = 0; var2 < 16; ++var2) {
			for(var3 = 0; var3 < 16; ++var3) {
				...
				int var5;
				for(var5 = var2 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a; var4 > 0 && Block.lightOpacity[this.blocks[var5 + var4 - 1] & 255] == 0; --var4) {
					;
				}
				...
				if(!this.worldObj.worldProvider.hasNoSky) {
					int var6 = 15;
					int var7 = this.worldObj.field_35472_c - 1;
	...
	private void func_35839_k() {
		if(this.worldObj.doChunksNearChunkExist(this.xPosition * 16 + 8, this.worldObj.field_35472_c / 2, this.zPosition * 16 + 8, 16)) {
	...
	private void updateSkylightNeighborHeight(int var1, int var2, int var3, int var4) {
		if(var4 > var3 && this.worldObj.doChunksNearChunkExist(var1, this.worldObj.field_35472_c / 2, var2, 16)) {
	...
	private void relightBlock(int var1, int var2, int var3) {
		...
		for(int var6 = var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a; var5 > 0 && Block.lightOpacity[this.blocks[var6 + var5 - 1] & 255] == 0; --var5) {
			;
		}
		...
		if(var5 != var4) {
			...
			if(var5 < this.lowestBlockHeight) {
				...
				var7 = this.worldObj.field_35472_c - 1;
	...
	public int getBlockID(int var1, int var2, int var3) {
		return this.blocks[var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a | var2] & 255;
	}
	...
	public boolean setBlockIDWithMetadata(int var1, int var2, int var3, int var4, int var5) {
		...
		int var9 = this.blocks[var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a | var2] & 255;
		if(var9 == var4 && this.data.getNibble(var1, var2, var3) == var5) {
			return false;
		} else {
			int var10 = this.xPosition * 16 + var1;
			int var11 = this.zPosition * 16 + var3;
			this.blocks[var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a | var2] = (byte)(var6 & 255);
			if(var9 != 0) {
				if(!this.worldObj.multiplayerWorld) {
					Block.blocksList[var9].onBlockRemoval(this.worldObj, var10, var2, var11);
				} else if(Block.blocksList[var9] instanceof BlockContainer) {
	...
	public boolean setBlockID(int var1, int var2, int var3, int var4) {
		...
		int var8 = this.blocks[var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a | var2] & 255;
		if(var8 == var4) {
			return false;
		} else {
			int var9 = this.xPosition * 16 + var1;
			int var10 = this.zPosition * 16 + var3;
			this.blocks[var1 << this.worldObj.field_35471_b | var3 << this.worldObj.field_35473_a | var2] = (byte)(var5 & 255);
			if(var8 != 0) {
	...
	public int setChunkData(byte[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		for(var9 = var2; var9 < var5; ++var9) {
			for(var10 = var4; var10 < var7; ++var10) {
				var11 = var9 << this.worldObj.field_35471_b | var10 << this.worldObj.field_35473_a | var3;
				var12 = var6 - var3;
		...
		for(var9 = var2; var9 < var5; ++var9) {
			for(var10 = var4; var10 < var7; ++var10) {
				var11 = (var9 << this.worldObj.field_35471_b | var10 << this.worldObj.field_35473_a | var3) >> 1;
				var12 = (var6 - var3) / 2;
	...
	public int func_35840_c(int var1, int var2) {
		...
		if(var4 == -999) {
			int var5 = this.worldObj.field_35472_c - 1;
			var4 = -1;
