...
public class PacketSkinURL implements SpoutPacket{
	...
	public void run(int PlayerId) {
		EntityPlayer e = Spout.getPlayerFromId(entityId);
		if (e != null) {
				...
				WorldUtil.releaseEntitySkin(Spout.getGameInstance().theWorld, e);
			WorldUtil.obtainEntitySkin(Spout.getGameInstance().theWorld, e);
		}
	}
