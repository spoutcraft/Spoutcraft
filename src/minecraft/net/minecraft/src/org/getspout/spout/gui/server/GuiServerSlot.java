...
public class GuiServerSlot extends GuiSlot {
	...
	public void drawSlot(int var1, int var2, int var3, int var4, Tessellator var5) {
		try {
			String var6 = ((mcSBServer)this.parentServerGui.serverList.get(var1)).name;
			if(var6 == null || MathHelper.stringNullOrLengthZero(var6)) {
				var6 = GuiMultiplayer.func_22087_f(this.parentServerGui) + " " + "";
			}

			String var7 = "";
			var7 = ((mcSBServer)this.parentServerGui.serverList.get(var1)).players + "" + "/" + ((mcSBServer)this.parentServerGui.serverList.get(var1)).maxPlayers + "";
			long var8 = 22L;
			var7 = var7 + ", " + ((mcSBServer)this.parentServerGui.serverList.get(var1)).country;
			String var10 = "";
			...
			this.parentServerGui.drawString(Spout.getGameInstance().fontRenderer, var10, var2 + 2, var3 + 12 + 10, 8421504);
