...
import org.getspout.spout.block.SpoutCustomItem; //Spout custom item
...
public class Item
{
    ...
    public static Item flint = (new SpoutCustomItem(62)).setIconCoord(6, 0).setItemName("flint"); //Spout changed to SpoutCustomItem
