...
public class RenderBlocks {
	...
	public boolean func_35927_a(int var1, int var2, int var3, int var4) {
		if(this != null) {
			return false;
		} else {
			byte var5 = 13;
			byte var6 = 52;
			byte var7 = 32;
			int var8 = MathHelper.func_35597_a(var1 - var5);
			int var9 = MathHelper.func_35597_a(var3 - var6);
			if(var9 <= var7 && var8 <= var7 && (var8 == var7 || var9 == var7) && this.field_35942_c[this.blockAccess.getBlockId(var1, var2, var3)]) {
				int var10 = 5;
				if(var1 == var5 - var7) {
					--var10;
				}
				...
				this.func_35921_b(var10, var1, var2, var3);
				return true;
			} else {
				return false;
			}
	...
	private boolean renderBlockBed(Block var1, int var2, int var3, int var4) {
		...
		var5.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3 + 1, var4));
		...
		var27 = ModelBed.headInvisibleFace[var7];
		if(var8) {
			var27 = ModelBed.headInvisibleFace[ModelBed.footInvisibleFaceRemap[var7]];
		}
		...
		if(var27 != 2 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2))) {
			var5.setBlendTexture(var1.minZ > 0.0D?var25:var1.func_35275_c(this.blockAccess, var2, var3, var4 - 1));
		...
		if(var27 != 3 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3))) {
			var5.setBlendTexture(var1.maxZ < 1.0D?var25:var1.func_35275_c(this.blockAccess, var2, var3, var4 + 1));
			var5.setColorOpaque_F(var11, var11, var11);
		...
		if(var27 != 4 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4))) {
			var5.setBlendTexture(var1.minZ > 0.0D?var25:var1.func_35275_c(this.blockAccess, var2 - 1, var3, var4));
		...
		if(var27 != 5 && (this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5))) {
			var5.setBlendTexture(var1.maxZ < 1.0D?var25:var1.func_35275_c(this.blockAccess, var2 + 1, var3, var4));
			var5.setColorOpaque_F(var12, var12, var12);
	...
	public boolean renderBlockTorch(Block var1, int var2, int var3, int var4) {
		...
		var6.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3, var4));
	...
	private boolean renderBlockRepeater(Block var1, int var2, int var3, int var4) {
		...
		var8.addVertexWithUV(var39, var49, var47, var23, var27);
		var8.addVertexWithUV(var37, var49, var45, var23, var29);
		var8.addVertexWithUV(var35, var49, var43, var25, var29);
		var8.addVertexWithUV(var33, var49, var41, var25, var27);
		return true;
	}
	...
	public boolean renderBlockLever(Block var1, int var2, int var3, int var4) {
		...
		var8.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3, var4));
		float var13 = 1.0F;
		if(Block.lightValue[var1.blockID] > 0) {
			var13 = 1.0F;
		}
	...
	public boolean func_35921_b(int var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		...
		for(int var6 = 0; var6 < 6; ++var6) {
			...
			if((var6 != 2 && var6 != 3 || (var1 - 1) / 3 != 1) && (var6 != 4 && var6 != 5 || (var1 - 1) % 3 != 1)) {
				...
				if(!this.field_35942_c[this.blockAccess.getBlockId(var7, var8, var9)]) {
					short var12 = 16384 /*GL_LIGHT0*/;
					var5.setColorOpaque_I(var12);
					var5.setBlendTexture(this.blockAccess.func_35451_b(var7, var8, var9, 2));
	...
	public boolean renderBlockFire(Block var1, int var2, int var3, int var4) {
		...
		var5.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3, var4));
		int var7 = (var6 & 15) << 4;
		int var8 = var6 & 240;
	...
	public boolean func_35929_i(Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		int var6 = var1.getBlockTextureFromSide(0);
		if(this.overrideBlockTexture >= 0) {
			var6 = this.overrideBlockTexture;
	...
	public boolean func_35922_a(BlockPane var1, int var2, int var3, int var4) {
	...
	public boolean renderBlockCrops(Block var1, int var2, int var3, int var4) {
		...
		Tessellator var6 = Tessellator.instance;
		var6.setBlendTexture(var5.func_35275_c(this.blockAccess, var2, var3, var4));
		float var7 = 1.0F;
		...
		if(var15 < 0) {
			this.func_35928_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var5.maxY, (double)var2, (double)var3, (double)var4);
		} else {
			this.func_35928_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), 0.5D, (double)var2, (double)var3, (double)var4);
			this.func_35926_a(var5, this.blockAccess.getBlockMetadata(var2, var3, var4), var15, var5.maxY, (double)var2, (double)var3, (double)var4);
		}

		return true;
	}

	public boolean func_35930_l(Block var1, int var2, int var3, int var4) {
		Tessellator var5 = Tessellator.instance;
		var5.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3, var4));
		var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
	...
	public void func_35928_a(Block var1, int var2, double var3, double var5, double var7, double var9) {
	...
	public void func_35926_a(Block var1, int var2, int var3, double var4, double var6, double var8, double var10) {
		Tessellator var12 = Tessellator.instance;
	...
	public boolean renderBlockFluids(Block var1, int var2, int var3, int var4) {
		...
		if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
			...
			double var24 = (double)this.func_1224_a(var2, var3, var4, var22);
			double var26 = (double)this.func_1224_a(var2, var3, var4 + 1, var22);
			double var28 = (double)this.func_1224_a(var2 + 1, var3, var4 + 1, var22);
			double var30 = (double)this.func_1224_a(var2 + 1, var3, var4, var22);
			int var35;
			int var32;
			if(this.renderAllFaces || var10) {
				var13 = true;
				var32 = var1.getBlockTextureFromSideAndMetadata(1, var23);
				float var33 = (float)BlockFluid.func_293_a(this.blockAccess, var2, var3, var4, var22);
				if(var33 > -999.0F) {
					var32 = var1.getBlockTextureFromSideAndMetadata(2, var23);
				}
				...
				var5.addVertexWithUV((double)(var2 + 0), (double)var3 + var24, (double)(var4 + 0), var36 - var42 - var40, var38 - var42 + var40);
				var5.addVertexWithUV((double)(var2 + 0), (double)var3 + var26, (double)(var4 + 1), var36 - var42 + var40, var38 + var42 + var40);
				var5.addVertexWithUV((double)(var2 + 1), (double)var3 + var28, (double)(var4 + 1), var36 + var42 + var40, var38 + var42 - var40);
				var5.addVertexWithUV((double)(var2 + 1), (double)var3 + var30, (double)(var4 + 0), var36 + var42 - var40, var38 - var42 - var40);
			}

			if(this.renderAllFaces || var11) {
				var5.setBlendTexture(var1.func_35275_c(this.blockAccess, var2, var3 - 1, var4));
				float var63 = 1.0F;
				var5.setColorOpaque_F(var14 * var63, var14 * var63, var14 * var63);
			...
			for(var32 = 0; var32 < 4; ++var32) {
				...
				int var65 = var1.getBlockTextureFromSideAndMetadata(var32 + 2, var23);
				int var37 = (var65 & 15) << 4;
				int var64 = var65 & 240;
				if(this.renderAllFaces || var12[var32]) {
					double var39;
					double var43;
					double var41;
					double var47;
					...
					double var55 = ((double)var64 + (1.0D - var39) * 16.0D) / 256.0D;
					double var57 = ((double)var64 + (1.0D - var41) * 16.0D) / 256.0D;
					double var59 = ((double)(var64 + 16) - 0.01D) / 256.0D;
					var5.setBlendTexture(var1.func_35275_c(this.blockAccess, var62, var3, var35));
					float var61 = 1.0F;
					if(var32 < 2) {
						var61 *= var16;
					} else {
					...
					var5.addVertexWithUV(var43, (double)var3 + var39, var45, var51, var55);
					var5.addVertexWithUV(var47, (double)var3 + var41, var49, var53, var57);
					var5.addVertexWithUV(var47, (double)(var3 + 0), var49, var53, var59);
					var5.addVertexWithUV(var43, (double)(var3 + 0), var45, var51, var59);
				}
			}
	...
	public void renderBlockFallingSand(Block var1, World var2, int var3, int var4, int var5) {
		...
		var10.setBlendTexture(var1.func_35275_c(var2, var3, var4, var5));
		float var11 = 1.0F;
		float var12 = 1.0F;
		if(var12 < var11) {
			var12 = var11;
...
//Spout HD end
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			if(this.field_35946_aj > 0) {
				...
				this.aoLightValueScratchXYNN = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4);
				this.aoLightValueScratchYZNN = var1.func_35276_e(this.blockAccess, var2, var3, var4 - 1);
				this.aoLightValueScratchYZNP = var1.func_35276_e(this.blockAccess, var2, var3, var4 + 1);
				this.aoLightValueScratchXYPN = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4);
				if(!this.aoGrassXYZCNN && !this.aoGrassXYZNNC) {
					this.aoLightValueScratchXYZNNN = this.aoLightValueScratchXYNN;
					this.field_35936_P = this.field_35935_Q;
				} else {
					this.aoLightValueScratchXYZNNN = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4 - 1);
				...
				if(!this.aoGrassXYZCNP && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNP = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4 + 1);
				...
				if(!this.aoGrassXYZCNN && !this.aoGrassXYZPNC) {
					...
					this.aoLightValueScratchXYZPNN = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4 - 1);
				...
				if(!this.aoGrassXYZCNP && !this.aoGrassXYZPNC) {
					...
					this.aoLightValueScratchXYZPNP = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4 + 1);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			if(this.field_35946_aj > 0) {
				...
				this.aoLightValueScratchXYNP = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4);
				this.aoLightValueScratchXYPP = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4);
				this.aoLightValueScratchYZPN = var1.func_35276_e(this.blockAccess, var2, var3, var4 - 1);
				this.aoLightValueScratchYZPP = var1.func_35276_e(this.blockAccess, var2, var3, var4 + 1);
				if(!this.aoGrassXYZCPN && !this.aoGrassXYZNPC) {
					this.aoLightValueScratchXYZNPN = this.aoLightValueScratchXYNP;
					this.field_35940_X = this.field_35939_Y;
				} else {
					this.aoLightValueScratchXYZNPN = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4 - 1);
				...
				if(!this.aoGrassXYZCPN && !this.aoGrassXYZPPC) {
					...
					this.aoLightValueScratchXYZPPN = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4 - 1);
				...
				if(!this.aoGrassXYZCPP && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPP = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4 + 1);
				...
				if(!this.aoGrassXYZCPP && !this.aoGrassXYZPPC) {
					...
					this.aoLightValueScratchXYZPPP = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4 + 1);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			if(this.field_35946_aj > 0) {
				--var4;
				this.aoLightValueScratchXZNN = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4);
				this.aoLightValueScratchYZNN = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4);
				this.aoLightValueScratchYZPN = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4);
				this.aoLightValueScratchXZPN = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4);
				...
				if(!this.aoGrassXYZNCN && !this.aoGrassXYZCNN) {
					...
					this.aoLightValueScratchXYZNNN = var1.func_35276_e(this.blockAccess, var2 - 1, var3 - 1, var4);
				...
				if(!this.aoGrassXYZNCN && !this.aoGrassXYZCPN) {
					...
					this.aoLightValueScratchXYZNPN = var1.func_35276_e(this.blockAccess, var2 - 1, var3 + 1, var4);
				...
				if(!this.aoGrassXYZPCN && !this.aoGrassXYZCNN) {
					...
					this.aoLightValueScratchXYZPNN = var1.func_35276_e(this.blockAccess, var2 + 1, var3 - 1, var4);
				...
				if(!this.aoGrassXYZPCN && !this.aoGrassXYZCPN) {
					...
					this.aoLightValueScratchXYZPPN = var1.func_35276_e(this.blockAccess, var2 + 1, var3 + 1, var4);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			if(this.field_35946_aj > 0) {
				++var4;
				this.aoLightValueScratchXZNP = var1.func_35276_e(this.blockAccess, var2 - 1, var3, var4);
				this.aoLightValueScratchXZPP = var1.func_35276_e(this.blockAccess, var2 + 1, var3, var4);
				this.aoLightValueScratchYZNP = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4);
				this.aoLightValueScratchYZPP = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4);
				...
				if(!this.aoGrassXYZNCP && !this.aoGrassXYZCNP) {
					...
					this.aoLightValueScratchXYZNNP = var1.func_35276_e(this.blockAccess, var2 - 1, var3 - 1, var4);
				...
				if(!this.aoGrassXYZNCP && !this.aoGrassXYZCPP) {
					...
					this.aoLightValueScratchXYZNPP = var1.func_35276_e(this.blockAccess, var2 - 1, var3 + 1, var4);
				...
				if(!this.aoGrassXYZPCP && !this.aoGrassXYZCNP) {
					...
					this.aoLightValueScratchXYZPNP = var1.func_35276_e(this.blockAccess, var2 + 1, var3 - 1, var4);
				...
				if(!this.aoGrassXYZPCP && !this.aoGrassXYZCPP) {
					...
					this.aoLightValueScratchXYZPPP = var1.func_35276_e(this.blockAccess, var2 + 1, var3 + 1, var4);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			if(this.field_35946_aj > 0) {
				--var2;
				this.aoLightValueScratchXYNN = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4);
				this.aoLightValueScratchXZNN = var1.func_35276_e(this.blockAccess, var2, var3, var4 - 1);
				this.aoLightValueScratchXZNP = var1.func_35276_e(this.blockAccess, var2, var3, var4 + 1);
				this.aoLightValueScratchXYNP = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4);
				...
				if(!this.aoGrassXYZNCN && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNN = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4 - 1);
				...
				if(!this.aoGrassXYZNCP && !this.aoGrassXYZNNC) {
					...
					this.aoLightValueScratchXYZNNP = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4 + 1);
				...
				if(!this.aoGrassXYZNCN && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPN = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4 - 1);
				...
				if(!this.aoGrassXYZNCP && !this.aoGrassXYZNPC) {
					...
					this.aoLightValueScratchXYZNPP = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4 + 1);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			if(this.field_35946_aj > 0) {
				++var2;
				this.aoLightValueScratchXYPN = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4);
				this.aoLightValueScratchXZPN = var1.func_35276_e(this.blockAccess, var2, var3, var4 - 1);
				this.aoLightValueScratchXZPP = var1.func_35276_e(this.blockAccess, var2, var3, var4 + 1);
				this.aoLightValueScratchXYPP = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4);
				...
				if(!this.aoGrassXYZPNC && !this.aoGrassXYZPCN) {
					...
					this.aoLightValueScratchXYZPNN = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4 - 1);
				...
				if(!this.aoGrassXYZPNC && !this.aoGrassXYZPCP) {
					...
					this.aoLightValueScratchXYZPNP = var1.func_35276_e(this.blockAccess, var2, var3 - 1, var4 + 1);
				...
				if(!this.aoGrassXYZPPC && !this.aoGrassXYZPCN) {
					...
					this.aoLightValueScratchXYZPPN = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4 - 1);
				...
				if(!this.aoGrassXYZPPC && !this.aoGrassXYZPCP) {
					...
					this.aoLightValueScratchXYZPPP = var1.func_35276_e(this.blockAccess, var2, var3 + 1, var4 + 1);
	...
	public boolean renderStandardBlockWithColorMultiplier(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			var8.setBlendTexture(var1.minY > 0.0D?var26:var1.func_35275_c(this.blockAccess, var2, var3 - 1, var4));
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			var8.setBlendTexture(var1.maxY < 1.0D?var26:var1.func_35275_c(this.blockAccess, var2, var3 + 1, var4));
		...
		int var28;
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			var8.setBlendTexture(var1.minZ > 0.0D?var26:var1.func_35275_c(this.blockAccess, var2, var3, var4 - 1));
...
//Spout end
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			var8.setBlendTexture(var1.maxZ < 1.0D?var26:var1.func_35275_c(this.blockAccess, var2, var3, var4 + 1));
			var8.setColorOpaque_F(var18, var21, var24);
...
//Spout end
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			var8.setBlendTexture(var1.minX > 0.0D?var26:var1.func_35275_c(this.blockAccess, var2 - 1, var3, var4));
...
//Spout end
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			var8.setBlendTexture(var1.maxX < 1.0D?var26:var1.func_35275_c(this.blockAccess, var2 + 1, var3, var4));		
			var8.setColorOpaque_F(var19, var22, var25);
...
//Spout end
	...
	public boolean func_1230_b(Block var1, int var2, int var3, int var4, float var5, float var6, float var7) {
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 - 1, var4, 0)) {
			var8.setBlendTexture(var1.minY > 0.0D?var28:var1.func_35275_c(this.blockAccess, var2, var3 - 1, var4));
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3 + 1, var4, 1)) {
			var8.setBlendTexture(var1.maxY < 1.0D?var28:var1.func_35275_c(this.blockAccess, var2, var3 + 1, var4));
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 - 1, 2)) {
			var8.setBlendTexture(var1.minZ > 0.0D?var28:var1.func_35275_c(this.blockAccess, var2, var3, var4 - 1));
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2, var3, var4 + 1, 3)) {
			var8.setBlendTexture(var1.maxZ < 1.0D?var28:var1.func_35275_c(this.blockAccess, var2, var3, var4 + 1));
			var8.setColorOpaque_F(var16, var20, var24);
			var8.setTranslationF(0.0F, 0.0F, -var26);
			this.renderWestFace(var1, (double)var2, (double)var3, (double)var4, var1.getBlockTexture(this.blockAccess, var2, var3, var4, 3));
			var8.setTranslationF(0.0F, 0.0F, var26);
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 - 1, var3, var4, 4)) {
			var8.setBlendTexture(var1.minX > 0.0D?var28:var1.func_35275_c(this.blockAccess, var2 - 1, var3, var4));
		...
		if(this.renderAllFaces || var1.shouldSideBeRendered(this.blockAccess, var2 + 1, var3, var4, 5)) {
			var8.setBlendTexture(var1.maxX < 1.0D?var28:var1.func_35275_c(this.blockAccess, var2 + 1, var3, var4));
			var8.setColorOpaque_F(var17, var21, var25);
			var8.setTranslationF(-var26, 0.0F, 0.0F);
			this.renderSouthFace(var1, (double)var2, (double)var3, (double)var4, var1.getBlockTexture(this.blockAccess, var2, var3, var4, 5));
			var8.setTranslationF(var26, 0.0F, 0.0F);
	...
	public boolean func_35925_a(BlockFence var1, int var2, int var3, int var4) {
		boolean var5 = false;
		float var6 = 0.375F;
		float var7 = 0.625F;
		...
		boolean var8 = false;
		boolean var9 = false;
		if(var1.func_35303_f(this.blockAccess, var2 - 1, var3, var4) || var1.func_35303_f(this.blockAccess, var2 + 1, var3, var4)) {
			var8 = true;
		}

		if(var1.func_35303_f(this.blockAccess, var2, var3, var4 - 1) || var1.func_35303_f(this.blockAccess, var2, var3, var4 + 1)) {
			var9 = true;
		}

		boolean var10 = var1.func_35303_f(this.blockAccess, var2 - 1, var3, var4);
		boolean var11 = var1.func_35303_f(this.blockAccess, var2 + 1, var3, var4);
		boolean var12 = var1.func_35303_f(this.blockAccess, var2, var3, var4 - 1);
		boolean var13 = var1.func_35303_f(this.blockAccess, var2, var3, var4 + 1);
		if(!var8 && !var9) {
			var8 = true;
		}
	...
	public boolean func_35923_a(BlockFenceGate var1, int var2, int var3, int var4) {
		boolean var5 = true;
		int var6 = this.blockAccess.getBlockMetadata(var2, var3, var4);
	...
	public boolean renderBlockDoor(Block var1, int var2, int var3, int var4) {
		...
		var5.setBlendTexture(var1.minY > 0.0D?var12:var1.func_35275_c(this.blockAccess, var2, var3 - 1, var4));
		var5.setColorOpaque_F(var8, var8, var8);
		this.renderBottomFace(var1, (double)var2, (double)var3, (double)var4, var1.getBlockTexture(this.blockAccess, var2, var3, var4, 0));
		var7 = true;
		var5.setBlendTexture(var1.maxY < 1.0D?var12:var1.func_35275_c(this.blockAccess, var2, var3 + 1, var4));
		var5.setColorOpaque_F(var9, var9, var9);
		this.renderTopFace(var1, (double)var2, (double)var3, (double)var4, var1.getBlockTexture(this.blockAccess, var2, var3, var4, 1));
		var7 = true;
		var5.setBlendTexture(var1.minZ > 0.0D?var12:var1.func_35275_c(this.blockAccess, var2, var3, var4 - 1));
		var5.setColorOpaque_F(var10, var10, var10);
		...
		var7 = true;
		this.flipTexture = false;
		var5.setBlendTexture(var1.maxZ < 1.0D?var12:var1.func_35275_c(this.blockAccess, var2, var3, var4 + 1));
		var5.setColorOpaque_F(var10, var10, var10);
		...
		var7 = true;
		this.flipTexture = false;
		var5.setBlendTexture(var1.minX > 0.0D?var12:var1.func_35275_c(this.blockAccess, var2 - 1, var3, var4));
		var5.setColorOpaque_F(var11, var11, var11);
		...
		var7 = true;
		this.flipTexture = false;
		var5.setBlendTexture(var1.maxX < 1.0D?var12:var1.func_35275_c(this.blockAccess, var2 + 1, var3, var4));
		var5.setColorOpaque_F(var11, var11, var11);
	...
	public void renderBottomFace(Block var1, double var2, double var4, double var6, int var8) {
		...
		if(this.enableAO) {
			...
			var9.setBlendTexture(this.field_35943_ak);
			...
			var9.setBlendTexture(this.field_35944_al);
			...
			var9.setBlendTexture(this.field_35947_am);
			...
			var9.setBlendTexture(this.field_35948_an);
	...
	public void renderWestFace(Block block, double worldX, double worldY, double worldZ, int textureID) {
		Tessellator blockVertexRenderer = Tessellator.instance;
		if(this.overrideBlockTexture >= 0) {
			textureID = this.overrideBlockTexture;
		}

		int subTexX = (textureID & 15) << 4;
		int subTexY = textureID & 240;
		double uvMinU = ((double)subTexX + block.minX * 16.0D) / 256.0D;
		double uvMaxU = ((double)subTexX + block.maxX * 16.0D - 0.01D) / 256.0D;
		double uvMinV = ((double)(subTexY + 16) - block.maxY * 16.0D) / 256.0D;
		double uvMaxV = ((double)(subTexY + 16) - block.minY * 16.0D - 0.01D) / 256.0D;
		double uvFlip;
		if(this.flipTexture) {
			uvFlip = uvMinU;
			uvMinU = uvMaxU;
		...
		if(block.minX < 0.0D || block.maxX > 1.0D) {
			uvMinU = (double)(((float)subTexX + 0.0F) / 256.0F);
			uvMaxU = (double)(((float)subTexX + 15.99F) / 256.0F);
		}

		if(block.minY < 0.0D || block.maxY > 1.0D) {
			uvMinV = (double)(((float)subTexY + 0.0F) / 256.0F);
			uvMaxV = (double)(((float)subTexY + 15.99F) / 256.0F);
		}
		...
		if(this.uvRotateWest == 1) {
			uvMinU = ((double)subTexX + block.minY * 16.0D) / 256.0D;
			uvMaxV = ((double)(subTexY + 16) - block.minX * 16.0D) / 256.0D;
			uvMaxU = ((double)subTexX + block.maxY * 16.0D) / 256.0D;
			uvMinV = ((double)(subTexY + 16) - block.maxX * 16.0D) / 256.0D;
			var24 = uvMinV;
			var26 = uvMaxV;
			uvFlip = uvMinU;
			var22 = uvMaxU;
			...
			uvMinU = ((double)(subTexX + 16) - block.maxY * 16.0D) / 256.0D;
			uvMinV = ((double)subTexY + block.minX * 16.0D) / 256.0D;
			uvMaxU = ((double)(subTexX + 16) - block.minY * 16.0D) / 256.0D;
			uvMaxV = ((double)subTexY + block.maxX * 16.0D) / 256.0D;
			uvFlip = uvMaxU;
			var22 = uvMinU;
			uvMinU = uvMaxU;
			uvMaxU = var22;
			...
			uvMinU = ((double)(subTexX + 16) - block.minX * 16.0D) / 256.0D;
			uvMaxU = ((double)(subTexX + 16) - block.maxX * 16.0D - 0.01D) / 256.0D;
			uvMinV = ((double)subTexY + block.maxY * 16.0D) / 256.0D;
			uvMaxV = ((double)subTexY + block.minY * 16.0D - 0.01D) / 256.0D;
			uvFlip = uvMaxU;
			var22 = uvMinU;
			var24 = uvMinV;
			var26 = uvMaxV;
		...
		double blockMinX = worldX + block.minX;
		double blockMaxX = worldX + block.maxX;
		double blockMinY = worldY + block.minY;
		double blockMaxY = worldY + block.maxY;
		double blokcMaxZ = worldZ + block.maxZ;
		if(this.enableAO) {
			blockVertexRenderer.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
			blockVertexRenderer.setBlendTexture(this.field_35943_ak);
			blockVertexRenderer.addVertexWithUV(blockMinX, blockMaxY, blokcMaxZ, uvMinU, uvMinV);
			blockVertexRenderer.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
			blockVertexRenderer.setBlendTexture(this.field_35944_al);
			blockVertexRenderer.addVertexWithUV(blockMinX, blockMinY, blokcMaxZ, var22, var26);
			blockVertexRenderer.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
			blockVertexRenderer.setBlendTexture(this.field_35947_am);
			blockVertexRenderer.addVertexWithUV(blockMaxX, blockMinY, blokcMaxZ, uvMaxU, uvMaxV);
			blockVertexRenderer.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
			blockVertexRenderer.setBlendTexture(this.field_35948_an);
			blockVertexRenderer.addVertexWithUV(blockMaxX, blockMaxY, blokcMaxZ, uvFlip, var24);
		} else {
			blockVertexRenderer.addVertexWithUV(blockMinX, blockMaxY, blokcMaxZ, uvMinU, uvMinV);
			blockVertexRenderer.addVertexWithUV(blockMinX, blockMinY, blokcMaxZ, var22, var26);
			blockVertexRenderer.addVertexWithUV(blockMaxX, blockMinY, blokcMaxZ, uvMaxU, uvMaxV);
	...
	public void renderBlockOnInventory(Block var1, int var2, float var3) {
		...
		if(var6 != 0 && var6 != 16) {
			if(var6 == 1) {
				...
				this.func_35928_a(var1, var2, var1.maxY, -0.5D, -0.5D, -0.5D);
				var4.draw();
			} else if(var6 == 13) {
				var1.setBlockBoundsForItemRender();
				...
				ChestItemRenderHelper.field_35611_a.func_35609_a(var1, var2, var3);
				GL11.glEnable('\u803a');
			} else if(var6 == 6) {
				var4.startDrawingQuads();
				var4.setNormal(0.0F, -1.0F, 0.0F);
			...
			if(var5 && this.useInventoryTint) {
				var11 = var1.getRenderColor(var2);
