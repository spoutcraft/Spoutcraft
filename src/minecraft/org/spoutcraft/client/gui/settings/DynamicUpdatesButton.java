...
public class DynamicUpdatesButton extends AutomatedCheckBox{
	public DynamicUpdatesButton() {
		super("Dynamic Updates");
		setChecked(ConfigReader.dynamicUpdates);
	...
	public void onButtonClick(ButtonClickEvent event) {
		ConfigReader.dynamicUpdates = !ConfigReader.dynamicUpdates;
		ConfigReader.write();
	}
}
