...
public class GuiAbout extends GuiScreen {
	...
	Texture beastNodeLogo = CustomTextureManager.getTextureFromJar(FileUtil.getAssetsDir().getPath()+"/logo/beastnode.png");
	Texture minecraftBizLogo = CustomTextureManager.getTextureFromJar(FileUtil.getAssetsDir().getPath()+"/logo/minecraft_biz.png");
