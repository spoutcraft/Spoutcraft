	...
	public boolean canSpawn(World world, int x, int z) {
		...
		switch (world.getEnvironment()) {
			case NETHER:
				return true;
			case SKYLANDS:
				return highest.getType() != MaterialData.air && highest.getType() != MaterialData.water && highest.getType() != MaterialData.lava;
			case NORMAL:
			default:
				return highest.getType() == MaterialData.sand || highest.getType() == MaterialData.gravel;
		}
	}
