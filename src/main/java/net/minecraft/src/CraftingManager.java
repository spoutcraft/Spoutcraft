...
public class CraftingManager {
	...
	private CraftingManager() {
		...
		this.addRecipe(new ItemStack(Block.field_94339_ct, 1), new Object[] {"##", "##", '#', Item.field_94583_ca});
		...
		this.addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 7), new Object[] {"###", '#', Block.field_94339_ct});
		...
		this.addRecipe(new ItemStack(Block.field_94337_cv, 6), new Object[] {"XSX", "X#X", "XSX", 'X', Item.ingotIron, '#', Block.torchRedstoneActive, 'S', Item.stick});
		...
		this.addRecipe(new ItemStack(Item.field_94582_cb, 1), new Object[] {"A", "B", 'A', Block.tnt, 'B', Item.minecartEmpty});
		this.addRecipe(new ItemStack(Item.field_96600_cc, 1), new Object[] {"A", "B", 'A', Block.field_94340_cs, 'B', Item.minecartEmpty});
		...
		this.addRecipe(new ItemStack(Block.field_94338_cu, 4), new Object[] {"#  ", "## ", "###", '#', Block.field_94339_ct});
		...
		this.addRecipe(new ItemStack(Block.field_94345_cm, 1), new Object[] {"##", '#', Item.ingotIron});
		this.addRecipe(new ItemStack(Block.field_94348_cl, 1), new Object[] {"##", '#', Item.ingotGold});
		this.addRecipe(new ItemStack(Block.dispenser, 1), new Object[] {"###", "#X#", "#R#", '#', Block.cobblestone, 'X', Item.bow, 'R', Item.redstone});
		this.addRecipe(new ItemStack(Block.field_96469_cy, 1), new Object[] {"###", "# #", "#R#", '#', Block.cobblestone, 'R', Item.redstone});
		...
		this.addRecipe(new ItemStack(Block.field_94344_cp), new Object[] {"GGG", "QQQ", "WWW", 'G', Block.glass, 'Q', Item.field_94583_ca, 'W', Block.woodSingleSlab});
		this.addRecipe(new ItemStack(Block.field_94340_cs), new Object[] {"I I", "ICI", " I ", 'I', Item.ingotIron, 'C', Block.chest});
