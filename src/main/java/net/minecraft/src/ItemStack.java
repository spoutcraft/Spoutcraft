...
public final class ItemStack {
	...
	public boolean isItemStackDamageable() {
		//TODO - Spout Catch NullPointerException if an item has a bad ID or not in the items list
		try {
			return Item.itemsList[this.itemID].getMaxDamage() > 0;
		} catch (NullPointerException e) {		
			System.out.println("WARNING: Retrieving item id: " + this.itemID + " failed, marking as not damageable");
			return false;
		}
		//TODO - Spout end
	}
