...
public class TexturePortalFX extends TextureFX {
	...
	/** Portal texture data */
	private byte[][] portalTextureData; // MCPatcher

	public TexturePortalFX() {
		super(Block.portal.blockIndexInTexture);
		this.portalTextureData = new byte[32][TileSize.int_numBytes]; // MCPatcher
		...
		for (int var2 = 0; var2 < 32; ++var2) {
			...
			for (int var3 = 0; var3 < TileSize.int_size; ++var3) {
				...
				// MCPatcher End
					...
					int var16 = var4 * TileSize.int_size + var3; // MCPatcher
	...
	public void onTick() {
		...
		for (int var2 = 0; var2 < TileSize.int_numPixels; ++var2) { // MCPatcher
