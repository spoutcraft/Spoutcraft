...
public class TexturePortalFX extends TextureFX {
	...
	public TexturePortalFX() {
		...
		this.portalTextureData = new byte[32][TileSize.int_numBytes]; // Spout HD 
		Random var1 = new Random(100L);

		for (int var2 = 0; var2 < 32; ++var2) {
			for (int var3 = 0; var3 < TileSize.int_size; ++var3) { // Spout HD 
				for (int var4 = 0; var4 < TileSize.int_size; ++var4) { // Spout HD 
					float var5 = 0.0F;
					int var6;
					...
					int var16 = var4 * TileSize.int_size + var3; // Spout HD 
	...
	public void onTick() {
		...
		for (int var2 = 0; var2 < TileSize.int_numPixels; ++var2) { // Spout HD 
