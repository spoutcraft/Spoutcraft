...
// Spout HD End
	...
	private boolean func_82780_a(BlockFlowerPot par1BlockFlowerPot, int par2, int par3, int par4) {
		...
		if (var19 != 0) {
			...
			if (var17 != null) {
				...
				float var18 = 0.125F;
				Block.cactus.setBlockBounds(0.5F - var18, 0.0F, 0.5F - var18, 0.5F + var18, 0.25F, 0.5F + var18);
				this.renderStandardBlock(Block.cactus, par2, par3, par4);
				Block.cactus.setBlockBounds(0.5F - var18, 0.25F, 0.5F - var18, 0.5F + var18, 0.5F, 0.5F + var18);
				this.renderStandardBlock(Block.cactus, par2, par3, par4);
				Block.cactus.setBlockBounds(0.5F - var18, 0.5F, 0.5F - var18, 0.5F + var18, 0.75F, 0.5F + var18);
				this.renderStandardBlock(Block.cactus, par2, par3, par4);
				Block.cactus.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
			} else if (var19 == 3) {
	...
	private float func_82777_a(BlockAnvil par1BlockAnvil, int par2, int par3, int par4, int par5, float par6, float par7, float par8, float par9, boolean par10, boolean par11, int par12) {
		...
		par1BlockAnvil.setBlockBounds(0.5F - par7, par6, 0.5F - par9, 0.5F + par7, par6 + par8, 0.5F + par9);
	...
	private boolean renderBlockRepeater(Block par1Block, int par2, int par3, int par4) {
		...
		if (!var11) {
			...
			switch (var6) {
				...
				case 2:
				default:
					par1Block.setBlockBounds(var22 / 16.0F + (float)var12, 0.125F, var24 / 16.0F + (float)var14, var23 / 16.0F + (float)var12, 0.25F, var25 / 16.0F + (float)var14);
					...
					this.renderStandardBlock(par1Block, par2, par3, par4);
					par1Block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 0.125F, 1.0F);
					this.clearOverrideBlockTexture();
			}
		}
...
// Spout HD End
	...
	private boolean func_82778_a(BlockBeacon par1BlockBeacon, int par2, int par3, int par4) {
		...
		par1BlockBeacon.setBlockBounds(0.125F, 0.0F, 0.125F, 0.875F, var5, 0.875F);
		this.renderStandardBlock(par1BlockBeacon, par2, par3, par4);
		this.func_82774_a(Block.glass.blockIndexInTexture);
		par1BlockBeacon.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
		this.renderStandardBlock(par1BlockBeacon, par2, par3, par4);
		this.func_82774_a(41);
		par1BlockBeacon.setBlockBounds(0.1875F, var5, 0.1875F, 0.8125F, 0.875F, 0.8125F);
		this.renderStandardBlock(par1BlockBeacon, par2, par3, par4);
		this.clearOverrideBlockTexture();
		return true;
	}
	...
	public boolean func_82779_a(BlockWall par1BlockWall, int par2, int par3, int par4) {
		...
		if ((var9 || var10) && var11) {
			if (var9) {
				par1BlockWall.setBlockBounds(0.3125F, 0.0F, 0.0F, 0.6875F, 0.8125F, 1.0F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			} else {
				par1BlockWall.setBlockBounds(0.0F, 0.0F, 0.3125F, 1.0F, 0.8125F, 0.6875F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			}
		} else {
			par1BlockWall.setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 1.0F, 0.75F);
			this.renderStandardBlock(par1BlockWall, par2, par3, par4);

			if (var5) {
				par1BlockWall.setBlockBounds(0.0F, 0.0F, 0.3125F, 0.25F, 0.8125F, 0.6875F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			}

			if (var6) {
				par1BlockWall.setBlockBounds(0.75F, 0.0F, 0.3125F, 1.0F, 0.8125F, 0.6875F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			}

			if (var7) {
				par1BlockWall.setBlockBounds(0.3125F, 0.0F, 0.0F, 0.6875F, 0.8125F, 0.25F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			}

			if (var8) {
				par1BlockWall.setBlockBounds(0.3125F, 0.0F, 0.75F, 0.6875F, 0.8125F, 1.0F);
				this.renderStandardBlock(par1BlockWall, par2, par3, par4);
			}
		}
	...
	public boolean renderBlockFenceGate(BlockFenceGate par1BlockFenceGate, int par2, int par3, int par4) {
		...
		if (var8 != 3 && var8 != 1) {
			...
			var17 = 0.4375F;
			var18 = 0.5625F;
			par1BlockFenceGate.setBlockBounds(var15, var13, var17, var16, var14, var18);
		...
		if (var7) {
			if (var8 == 3) {
				par1BlockFenceGate.setBlockBounds(0.8125F, var9, 0.0F, 0.9375F, var12, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.8125F, var9, 0.875F, 0.9375F, var12, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.5625F, var9, 0.0F, 0.8125F, var10, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.5625F, var9, 0.875F, 0.8125F, var10, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.5625F, var11, 0.0F, 0.8125F, var12, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.5625F, var11, 0.875F, 0.8125F, var12, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			} else if (var8 == 1) {
				par1BlockFenceGate.setBlockBounds(0.0625F, var9, 0.0F, 0.1875F, var12, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.0625F, var9, 0.875F, 0.1875F, var12, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.1875F, var9, 0.0F, 0.4375F, var10, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.1875F, var9, 0.875F, 0.4375F, var10, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.1875F, var11, 0.0F, 0.4375F, var12, 0.125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.1875F, var11, 0.875F, 0.4375F, var12, 1.0F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			} else if (var8 == 0) {
				par1BlockFenceGate.setBlockBounds(0.0F, var9, 0.8125F, 0.125F, var12, 0.9375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var9, 0.8125F, 1.0F, var12, 0.9375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.0F, var9, 0.5625F, 0.125F, var10, 0.8125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var9, 0.5625F, 1.0F, var10, 0.8125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.0F, var11, 0.5625F, 0.125F, var12, 0.8125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var11, 0.5625F, 1.0F, var12, 0.8125F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			} else if (var8 == 2) {
				par1BlockFenceGate.setBlockBounds(0.0F, var9, 0.0625F, 0.125F, var12, 0.1875F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var9, 0.0625F, 1.0F, var12, 0.1875F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.0F, var9, 0.1875F, 0.125F, var10, 0.4375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var9, 0.1875F, 1.0F, var10, 0.4375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.0F, var11, 0.1875F, 0.125F, var12, 0.4375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
				par1BlockFenceGate.setBlockBounds(0.875F, var11, 0.1875F, 1.0F, var12, 0.4375F);
				this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			}
			...
			var17 = 0.4375F;
			var18 = 0.5625F;
			par1BlockFenceGate.setBlockBounds(var15, var9, var17, var16, var12, var18);
			this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			var15 = 0.5F;
			var16 = 0.625F;
			par1BlockFenceGate.setBlockBounds(var15, var9, var17, var16, var12, var18);
			...
			var15 = 0.625F;
			var16 = 0.875F;
			par1BlockFenceGate.setBlockBounds(var15, var9, var17, var16, var10, var18);
			this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			par1BlockFenceGate.setBlockBounds(var15, var11, var17, var16, var12, var18);
			this.renderStandardBlock(par1BlockFenceGate, par2, par3, par4);
			var15 = 0.125F;
			var16 = 0.375F;
			par1BlockFenceGate.setBlockBounds(var15, var9, var17, var16, var10, var18);
	...
	public void renderBlockAsItem(Block par1Block, int par2, float par3) {
		...
		if (var6 != 0 && var6 != 31 && var6 != 16 && var6 != 26) {
			if (var6 == 1) {
				...
				for (var14 = 0; var14 < 2; ++var14) {
					if (var14 == 0) {
						par1Block.setBlockBounds(0.0F, 0.0F, 0.3125F, 1.0F, 0.8125F, 0.6875F);
					}

					if (var14 == 1) {
						par1Block.setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 1.0F, 0.75F);
					}
				...
				for (var14 = 0; var14 < 3; ++var14) {
					if (var14 == 0) {
						par1Block.setBlockBounds(0.125F, 0.0F, 0.125F, 0.875F, 0.1875F, 0.875F);
						this.func_82774_a(Block.obsidian.blockIndexInTexture);
					} else if (var14 == 1) {
						par1Block.setBlockBounds(0.1875F, 0.1875F, 0.1875F, 0.8125F, 0.875F, 0.8125F);
						this.func_82774_a(41);
					} else if (var14 == 2) {
						par1Block.setBlockBounds(0.0F, 0.0F, 0.0F, 1.0F, 1.0F, 1.0F);
						this.func_82774_a(Block.glass.blockIndexInTexture);
