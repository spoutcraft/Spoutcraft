...
final class TileOverrideImpl$Vertical extends TileOverride {
	private static final int[] neighborMap = new int[] {3, 2, 0, 1};

	TileOverrideImpl$Vertical(String var1, Properties var2, TileLoader var3) {
	...
	Icon getTileImpl(IBlockAccess var1, Block var2, Icon var3, int var4, int var5, int var6, int var7) {
		...
		if (this.shouldConnect(var1, var2, var3, var4, var5, var6, var7, var8[this.rotateUV(2)])) {
			var9 |= 1;
		}

		if (this.shouldConnect(var1, var2, var3, var4, var5, var6, var7, var8[this.rotateUV(6)])) {
			var9 |= 2;
		}
