...
class MobRuleList$MobRuleEntry {
	...
	static MobRuleList$MobRuleEntry load(Properties var0, int var1, int var2) {
		...
		WeightedIndex var12 = WeightedIndex.create(var4.length, var0.getProperty("weights." + var1, ""));
		...
		if (var12 == null) {
			...
			try {
				var8 = Integer.parseInt(var0.getProperty("maxHeight." + var1, "-1").trim());
				var9 = Integer.parseInt(var0.getProperty("minHeight." + var1, "-1").trim());
			...
			return new MobRuleList$MobRuleEntry(var4, var12, var6, var9, var8);
		}
	}
