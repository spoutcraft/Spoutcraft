...
class CustomAnimation$Tile implements CustomAnimation$Delegate {
	...
	CustomAnimation$Tile(CustomAnimation var1, int var2, int var3) throws IOException {
		...
		BufferedImage var4 = TextureUtils.getResourceAsBufferedImage(CustomAnimation.access$000(var1));
	...
	public void update(int var1, int var2) {
		if (this.isScrolling) {
			...
			int var3 = CustomAnimation.access$200(this.this$0) - CustomAnimation.access$700(this.this$0);
			GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, 0, CustomAnimation.access$300(this.this$0) + var1, CustomAnimation.access$400(this.this$0) + var2 + CustomAnimation.access$200(this.this$0) - var3, CustomAnimation.access$100(this.this$0), var3, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, (ByteBuffer)CustomAnimation.access$500(this.this$0).position(0));
			GL11.glTexSubImage2D(GL11.GL_TEXTURE_2D, 0, CustomAnimation.access$300(this.this$0) + var1, CustomAnimation.access$400(this.this$0) + var2, CustomAnimation.access$100(this.this$0), CustomAnimation.access$200(this.this$0) - var3, GL11.GL_RGBA, GL11.GL_UNSIGNED_BYTE, (ByteBuffer)CustomAnimation.access$500(this.this$0).position(4 * CustomAnimation.access$100(this.this$0) * var3));
		}
	}

	public int getDelay() {
		return this.maxScrollDelay > 0 ? CustomAnimation.access$800().nextInt(this.maxScrollDelay - this.minScrollDelay + 1) + this.minScrollDelay : 0;
	}
}
