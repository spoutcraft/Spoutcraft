...
What is Spoutcraft?
-------------------
Spoutcraft is the Minecraft client mod system for the Bukkit server plugin, SpoutPlugin, that exposes new API for other plugins to utilize, in an attempt to bring the Minecraft multiplayer experience to parity with the single-player modding experience.
